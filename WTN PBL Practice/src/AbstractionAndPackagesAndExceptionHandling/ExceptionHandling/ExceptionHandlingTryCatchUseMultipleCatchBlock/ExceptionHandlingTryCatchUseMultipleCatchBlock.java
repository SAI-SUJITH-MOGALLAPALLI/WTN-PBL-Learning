package AbstractionAndPackagesAndExceptionHandling.ExceptionHandling.ExceptionHandlingTryCatchUseMultipleCatchBlock;
import java.util.InputMismatchException;
import java.util.Scanner;
public class ExceptionHandlingTryCatchUseMultipleCatchBlock {
	...
	public static void main(String[] args) {
		...
		try {
			...
			int ind=sc.nextInt();
			System.out.println("The array element at index "+ind+" = "+ar[ind]+"\nThe array element successfully accessed\r\n");
		}
